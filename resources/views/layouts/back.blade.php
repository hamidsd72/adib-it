            ...
            <div class="row">
                <aside class="col-md-3">
                    <div class="card mb-4">
                        ...
                        <div class="w-100 mx-2 text-center" style="cursor:pointer" data-toggle="tooltip" data-placement="left" title="برای تغییر, روی زبان مورد نظر کلیک کنید">
                            <span>تغییر زبان پنل به : </span>
                            <a href="{{route('change-lang','en')}}">
                                en
                            </a>
                            <span>-</span>
                            <a href="{{route('change-lang','fa')}}">
                                fa
                            </a>
                            <span>-</span>
                            <a href="{{route('change-lang','tr')}}">
                                tr
                            </a>
                            <span>-</span>
                        ...
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li>
                                        <a href="{{ route('page.index') }}">صفحات داینامیک</a>
                                    </li>
                                    {{-- <li>
                                        <a href="{{ route('content.index') }}">محتوا صفحات</a>
                                    </li> --}}
                                    {{-- <li>
                                        <a href="{{ route('category-list') }}">لیست دسته بندی ها</a>
                                    </li> --}}
{{--                                    <li>--}}
{{--                                        <a href="{{ route('bb') }}">لیست خدمات (منوی فوتر)</a>--}}
{{--                                    </li>--}}
                                    <li>
                                    ...
                                    <li>
                                        <a href="{{ route('blog-category-list') }}">دسته بندی مقالات</a>
                                    </li>
