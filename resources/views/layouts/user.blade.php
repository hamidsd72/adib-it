...
<head style="">
    ...
    <link rel="stylesheet" type="text/css" href="{{url('assets/adib/new/css/animate.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{url('assets/adib/new/css/bootstrap.css')}}">
{{--    <link rel="stylesheet" type="text/css" href="{{url('assets/adib/new/css/font-awesome.css')}}">--}}
...
{{--    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/fonts/FontAwesome.otf">--}}
    <link rel="stylesheet" type="text/css" href="{{url('assets/adib/new/css/owl.carousel.css')}}">
    <link rel="stylesheet" type="text/css" href="{{url('assets/adib/new/css/settings.css')}}">
    <link rel="stylesheet" type="text/css" href="{{url('assets/adib/new/css/prettyPhoto.css')}}">
    <link rel="stylesheet" type="text/css" href="{{url('assets/adib/new/css/player/YTPlayer.css')}}">
    <link rel="icon" href="https://adib.com.tr/1-removebg-preview.png" type="image/png">
    {{--    font google--}}
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
{{--    <link href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@700&display=swap" rel="stylesheet">--}}
    <link rel="stylesheet" type="text/css" href="{{url('assets/adib/new/css/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{url('assets/adib/new/css/responsive.css')}}">
...
<div id="pageloader">
    <div class="loader-item">
        <img src="{{url("assets/adib/new/images/loading.gif")}}" alt='Loading...'/>
    </div>
</div>
<!-- End Page Loader-->
<!-- Home Section -->
            ...
            <div class="col-xs-9 left">
                <div class="top_details"
                    ...
                    <div class="language drop" >
                        {{-- new --}}
                        <div class="d-flex">
                            <a href="https://adib.com.tr/en"><img class="flag" src="{{url('assets/adib/new/images/en.png')}}" alt="icon"></a>
                            <a href="https://adib.com.tr/tr"><img class="flag" src="{{url('assets/adib/new/images/tr.png')}}" alt="icon"></a>
                            <a href="https://adib.com.tr/ar"><img class="flag" src="{{url('assets/adib/new/images/ar.png')}}" alt="icon"></a>
                            <a href="{{url('/')}}"><img class="flag" src="{{url('assets/adib/new/images/fa.png')}}" alt="icon"></a>
                        </div>
                        {{-- old --}}
                        {{-- @if($locale=='tr' )
                        ...
                        <div class="languages-panel">
                            <ul class="content">
                                <li><a href="https://adib.com.tr/en"><img style="width: 25px"
                                                                          src="{{url('assets/adib/new/images/en.png')}}"
                                                                          alt="icon">
                                        english
                                ...
                                <li><a href="https://adib.com.tr/tr">
                                        <img style="width: 25px" src="{{url('assets/adib/new/images/tr.png')}}" alt="icon">
                                        turkish
                                        @if($locale=='tr' )<i class="fa fa-check lang_checked"></i>@endif
                                    </a></li>
                                <li><a href="https://adib.com.tr/ar">
                                        <img style="width: 25px" src="{{url('assets/adib/new/images/ar.png')}}" alt="icon">
                                        arabic
                                        @if($locale=='ar' )<i class="fa fa-check lang_checked"></i>@endif
                                    </a></li>
                                <li><a href="{{url('/')}}">
                                        <img style="width: 25px" src="{{url('assets/adib/new/images/fa.png')}}" alt="icon">
                                        Persian
        ...
        <div class="content navigation">
            ...
            <div class="logo" style="display: flex;    justify-content: center;    align-items: center;height: 100%;">
                <a class="scroll" style="display: inline;margin-top: 0;" href="{{url('/')}}"><img
                            src="{{url('assets/1-removebg-preview.png')}}"
            ...
            <!-- Nav Menu -->
            @php
                $Menu = App\Models\Menu::where('id','!=','4')->get();
                $ProductCategory= App\Models\ProductCategory::all();
            ...
            <div class="tp-banner">
                <ul>
                    ...
                    <li class="revslide" data-transition="random" data-slotamount="7" data-masterspeed="800">
                        ...
                        <img src="{{url("assets/adib/new/images/slid_1.jpg")}}" alt="slidebg1"
                             data-bgfit="cover"
                             data-bgposition="center top" data-bgrepeat="no-repeat">
                        <!-- Layer 1 -->
...
{{--                        </div>--}}
                    ...
                    <li class="revslide" data-transition="random" data-slotamount="7" data-masterspeed="800">
                        <!-- MAIN IMAGE -->
                        <img src="{{url('assets/adib/new/images/rev-slider/slide2.jpg')}}" alt="slidebg2" data-bgfit="cover"
                             data-bgposition="center top" data-bgrepeat="no-repeat">
                        ...
                        <div class="tp-caption lfb customout"
                             ...
                             data-endeasing="Power4.easeIn"
                        >
                            <img src="{{url('assets/adib/new/images/rev-slider/write.png')}}" style="height: 430px!important;width: auto!important" alt="slider"/>
                        </div>
                        ...
                        <div class="tp-caption lft customout"
                             ...
                             data-endeasing="Power4.easeIn"
                        >
                            <img src="{{url('assets/adib/new/images/rev-slider/balon.png')}}" alt=""/>
                        </div>
                    ...
                    <li class="revslide" data-transition="random" data-slotamount="7" data-masterspeed="800">
                        ...
                        <img src="{{url("assets/adib/new/images/slid_2_back.jpg")}}" alt="slidebg3"
                             data-bgfit="cover" data-bgposition="center top" data-bgrepeat="no-repeat">
                        ...
                        <div class="tp-caption sfb customout"
                            ...
                            <img src="{{url("assets/adib/new/images/slid_2_girl.png")}}" style="width: 250px;" alt="check"/>
                        </div>
                        ...
                        <div class="tp-caption sft customout "
                            ...
                            <img src="{{url("assets/adib/new/images/slid_2_mark.png")}}" style="width: 100px;" alt="check"/>
                        </div>
...
{{--    <a target="_blank" rel="noreferrer" href="https://api.whatsapp.com/send?phone=+905317677479">--}}
    <a target="_blank" rel="noreferrer" href="https://api.whatsapp.com/send?phone=00905437707479">
        <img class="social_img" src="{{url('assets/adib/whatss4.png')}}" alt="whatsapp adib">
    </a>
</div>
<!-- End Footer Section -->

<script type="text/javascript" src="{{url('assets/adib/new/js/jquery-1.10.2.min.js')}}"></script>
<script type="text/javascript" src="{{url('assets/adib/new/js/bootstrap.js')}}"></script>
<script type="text/javascript" src="{{url('assets/adib/new/js/jquery.appear.js')}}"></script>
<script type="text/javascript" src="{{url('assets/adib/new/js/jquery.countTo.js')}}"></script>
<script type="text/javascript" src="{{url('assets/adib/new/js/waypoints.min.js')}}"></script>
<script type="text/javascript" src="{{url('assets/adib/new/js/jquery.prettyPhoto.js')}}"></script>
<script type="text/javascript" src="{{url('assets/adib/new/js/modernizr-latest.js')}}"></script>
<script type="text/javascript" src="{{url('assets/adib/new/js/SmoothScroll.js')}}"></script>
<script type="text/javascript" src="{{url('assets/adib/new/js/jquery.parallax-1.1.3.js')}}"></script>
<script type="text/javascript" src="{{url('assets/adib/new/js/jquery.easing.1.3.js')}}"></script>
<script type="text/javascript" src="{{url('assets/adib/new/js/jquery.sticky.js')}}"></script>
<script type="text/javascript" src="{{url('assets/adib/new/js/owl.carousel.js')}}"></script>
<script type="text/javascript" src="{{url('assets/adib/new/js/jquery.isotope.js')}}"></script>
<script type="text/javascript" src="{{url('assets/adib/new/js/rev-slider/jquery.themepunch.plugins.min.js')}}"></script>
<script type="text/javascript" src="{{url('assets/adib/new/js/rev-slider/jquery.themepunch.revolution.min.js')}}"></script>
<script type="text/javascript" src="{{url('assets/adib/new/js/jquery.mb.YTPlayer.js')}}"></script>
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@10"></script>
{{--<script src="http://maps.google.com/maps/api/js?sensor=false"></script>--}}
<script type="text/javascript" src="{{url('assets/adib/new/js/jquery.mapmarker.js')}}"></script>
<script type="text/javascript" src="{{url('assets/adib/new/js/scripts.js')}}"></script>
